...
/*   Updated: 2024/03/05 21:17:09 by aboukdid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	sem_t is for data type;
	sem_init() is to initialize the semaphore;
	sem_eait() is wait for the semaphore;
	sem_post() is like a signal;
*/
